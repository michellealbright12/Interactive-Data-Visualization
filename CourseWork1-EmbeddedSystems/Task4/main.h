...
#define MAIN_TASK   1
#define LED_1_ALARM 2
#define LED_2_ALARM 3
#define LED_3_ALARM 4
#define LED_4_ALARM 5

#define ENET_DEVICE 0
#define RTCS_DHCP 0

#define ENET_IPADDR IPADDR(192,168,105,186)
...
extern void LED_1_alarm (uint_32);
extern void LED_2_alarm (uint_32);
extern void LED_3_alarm (uint_32);
extern void LED_4_alarm (uint_32);
void button_push1 (void* ptr);
void button_push2 (void* ptr);
void button_push3 (void* ptr);
void button_push4 (void* ptr);
void button_push5 (void* ptr);
void button_push6 (void* ptr);
void rtcs_init (void);
